...
public class InvalidScopeException extends OAuth2Exception {
    ...
    private static final Logger LOG = Logger.getLogger(InvalidScopeException.class.getName());

    public InvalidScopeException(OAuth2 oauth) {
        super(oauth);
        ...
        addParameter(OAuth2.PARAMETER_ERROR, OAuth2.PARAMETER_ERROR_INVALID_SCOPE);
