...
public class HandleResourceOwnerPasswordCredentialsGrant extends OAuth2ResourceOperations implements HandleGrant {
    ...
    public HandleResourceOwnerPasswordCredentialsGrant(ResourceTokenManagement tokenManagement, 
