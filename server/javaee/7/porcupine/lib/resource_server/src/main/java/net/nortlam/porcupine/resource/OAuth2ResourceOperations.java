...
public class OAuth2ResourceOperations implements Serializable {

    private static final Logger LOG = Logger.getLogger(OAuth2ResourceOperations.class.getName());

    public OAuth2ResourceOperations() {
    }
...
//    }
    ...
    protected void redirectAuthorizationServer(ServletContext context, 
        ...
        switch(grant) {
            case AUTHORIZATION_CODE: 
                uri = requestAuthorizationCode(context, request, scope); break;
...
//            Host: server.example.com            
    ...
    protected URI requestAuthorizationCode(ServletContext context, 
                                ContainerRequestContext request, String scope) {
