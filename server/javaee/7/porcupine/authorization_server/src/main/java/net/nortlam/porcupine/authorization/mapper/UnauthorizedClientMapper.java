...
@Provider
public class UnauthorizedClientMapper implements ExceptionMapper<UnauthorizedClientException> {

    private static final Logger LOG = Logger.getLogger(UnauthorizedClientMapper.class.getName());

    @Override
    public Response toResponse(UnauthorizedClientException e) {
        ...
        OAuth2.PARAMETER_ERROR_UNAUTHORIZED_CLIENT, 
        e.buildParameters(), 
