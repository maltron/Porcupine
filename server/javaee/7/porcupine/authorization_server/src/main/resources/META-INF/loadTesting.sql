...
insert into PORCUPINE_SCOPE(NAME, DESCRIPTION, MESSAGE, IS_AUTHORIZATION_CODE_GRANT, IS_IMPLICIT_GRANT, IS_RESOURCE_OWNER_PASSWORD_CREDENTIALS_GRANT, IS_CLIENT_CREDENTIALS_GRANT, EXPIRATION, USERNAME, PASSWORD) values('DOCUMENTS', 'Testing for Resource Owner Password Credentials', 'The test application by Mauricio \"Maltron\" Leal would like the ability to access a sample document', false, false, true, false, 300000, 'hello@hello.com', '123');
insert into PORCUPINE_SCOPE(NAME, DESCRIPTION, MESSAGE, IS_AUTHORIZATION_CODE_GRANT, IS_IMPLICIT_GRANT, IS_RESOURCE_OWNER_PASSWORD_CREDENTIALS_GRANT, IS_CLIENT_CREDENTIALS_GRANT, EXPIRATION) values('REAL_NAME', 'Testing for Client Credentials', 'The test application by Mauricio \"Maltron\" Leal would like the ability to access your Real Name', false, false, false, true, 300000);
# Protected Resources
...
insert into PORCUPINE_PROTECTED_RESOURCE(RESOURCE) values('/testropc/rest/resource');
insert into PORCUPINE_PROTECTED_RESOURCE(RESOURCE) values('/testcc/rest/resource');
...
insert into PORCUPINE_SCOPE_ACCESS_PROTECTED_RESOURCES(SCOPE_ID, PROTECTED_RESOURCE_ID) values(4,7);
insert into PORCUPINE_SCOPE_ACCESS_PROTECTED_RESOURCES(SCOPE_ID, PROTECTED_RESOURCE_ID) values(5,8);
# Client
...
insert into PORCUPINE_CLIENT_HAS_SCOPES(CLIENT_ID, SCOPE_ID) values('cG9yY3VwaW5lLWNsaWVudC05OTYyMWZhZC1iOWY3LTRlYzctYTM3MS05ZjU2NWUyM2I5MGU=',4);
insert into PORCUPINE_CLIENT_HAS_SCOPES(CLIENT_ID, SCOPE_ID) values('cG9yY3VwaW5lLWNsaWVudC05OTYyMWZhZC1iOWY3LTRlYzctYTM3MS05ZjU2NWUyM2I5MGU=',5);
