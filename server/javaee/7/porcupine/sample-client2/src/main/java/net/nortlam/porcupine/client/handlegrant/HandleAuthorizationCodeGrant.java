...
public class HandleAuthorizationCodeGrant extends OAuth2ClientOperations implements HandleGrant {
    ...
    public HandleAuthorizationCodeGrant(ClientTokenManagement tokenManagement, String scope) {
        this.scope = scope;
    ...
    public void handle(ServletContext context, ContainerRequestContext request) throws IOException {
        LOG.log(Level.INFO, "handle() AUTHORIZATION CODE SELECTED");
